...
import org.lostcat.models.ImageResizer;
...
public class EntrepotImages {
	...
	private String putImage(String id, BufferedImage photo, String nameExtension, int width, int height) {
		try {
			String fileName = id + nameExtension + ".png";
			BufferedImage bufferedImage = ImageResizer.resize(width, height, photo);
